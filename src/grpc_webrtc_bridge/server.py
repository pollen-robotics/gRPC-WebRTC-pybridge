...
class GRPCWebRTCBridge:
    ...
    def on_open_service_channel(self, channel: Gst.Element) -> None:
        self.logger.info("channel service opened")

    def on_data_service_channel(self, data_channel, message: GLib.Bytes, grpc_client: GRPCClient, pc) -> None:  # type: ignore[no-untyped-def]
        ...
        # response = loop.run_until_complete(self.handle_service_request(request, grpc_client, pc))
        asyncio.run_coroutine_threadsafe(
            self.handle_service_request(request, data_channel, grpc_client, pc), self.producer._asyncloop
        )

        # data_channel.send_string(response.SerializeToString())
    ...
    async def handle_service_request(self, request: ServiceRequest, data_channel, grpc_client: GRPCClient, pc) -> None:  # type: ignore[no-untyped-def]
        ...
        # data_channel.send_string(resp.SerializeToString())
    ...
    def on_open_state_channel(self, channel: Gst.Element, request: Connect, grpc_client: GRPCClient) -> None:
        ...
        async def send_joint_state() -> None:
            async for state in grpc_client.get_reachy_state(
                ...
                # channel.send(state.SerializeToString())
    ...
    def on_reachy_command_datachannel_message(self, data_channel, message: GLib.Bytes, grpc_client: GRPCClient) -> None:  # type: ignore[no-untyped-def]
